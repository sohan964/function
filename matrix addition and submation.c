#include <stdio.h>
  ...
  int rows, columns;
  int matrixsubmation(int mat1[10][10], int mat2[10][10],int mat3[10][10])
  {
      int i,j;
      for(i=0;i<rows;i++)
      {
  ...
  int matrixAddition(int mat1[10][10], int mat2[10][10], int mat3[10][10]) {
        int i, j;
  ...
  int main() {
        ...
        matrixsubmation(matrix1,matrix2,matrix3);
        printf("\nResult of Matrix submation:\n");
        for(i=0;i<rows;i++)
        {
            for(j=0;j<columns;j++)
            {
